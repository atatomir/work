...
varr blocked("blocked", 55 * 55);
vint naux("naux"), maux("maux"), cntdeny("cntdeny");


void read_data_vechi(){
    set(cntpa, 0);
    set(cntde, 0);
...
void get_dir_smart_better(vint xs, vint ys, vint xd, vint yd, vint sol) {
    // copy room in aux_room
    set(aux, 0);
